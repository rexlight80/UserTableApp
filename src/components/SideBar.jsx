  ...
  return (
    <div className={`sideBarWrapper`}>
        ...
        <svg 
           ...
           className={`${expand ? 'isExpandIcon': ''}`}
        >
            <path 
            fill-rule="evenodd" 
            clip-rule="evenodd" 
            d="M2.22 10.78a.75.75 0 010-1.06l5.252-5.252a.75.75 0 011.06 0l5.252 5.252a.75.75 0 11-1.06 1.06L8.001 6.06 3.28 10.78a.75.75 0 01-1.06 0z"
            />
        </svg>
        </div>
        <div onClick={() => navigate('/')} className={`UserTable ${!expand ? 'notExpand': ''}`}>
    
<svg height="800px" width="800px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" 
	 viewBox="0 0 342.483 342.483" space="preserve">
<g>
